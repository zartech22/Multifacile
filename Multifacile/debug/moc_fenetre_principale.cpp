...
**
** Created: Mon 3. Jun 00:07:54 2013
...
static const char qt_meta_stringdata_Fenetre_principale[] = {
    "Fenetre_principale\0\0update\0"
    "checkUpdateReceivedAnswer(UpdateType)\0"
    "erreurSocket()\0nbr\0open_window(int)\0"
    "resetCentralWidget()\0action\0"
    "resetLabel(QAction*)\0setMode(QAction*)\0"
    "verification()\0"
};
...
void Fenetre_principale::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->checkUpdateReceivedAnswer((*reinterpret_cast< UpdateType(*)>(_a[1]))); break;
        case 1: _t->erreurSocket(); break;
        case 2: _t->open_window((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 3: _t->resetCentralWidget(); break;
        case 4: _t->resetLabel((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        case 5: _t->setMode((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        case 6: _t->verification(); break;
        default: ;
        }
    }
}
