...
static const char qt_meta_stringdata_CustomMessageBox[] = {
    "CustomMessageBox\0"
};
...
const QMetaObjectExtraData CustomMessageBox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CustomMessageBox::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CustomMessageBox,
      qt_meta_data_CustomMessageBox, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CustomMessageBox::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CustomMessageBox))
