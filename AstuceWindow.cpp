...
void AstuceWindow::astucesInit()
{
    ...
    astuces[10] = "Pour la table de 10, on rajoute un 0 au chiffre que multiplie 10.<br />Exemple :<br /><strong><span style=\"text-decoration: underline;\">5</span> x 10 = <span style=\"text-decoration: underline;\">50</span></strong>";
}
